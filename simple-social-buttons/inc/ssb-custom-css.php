...
<style media="screen">
	...
	.simplesocialbuttons.simplesocialbuttons_inline .ssb-fb-like, .simplesocialbuttons.simplesocialbuttons_inline amp-facebook-like {
		margin: <?php echo $this->inline_option['icon_space'] == '1' && $this->inline_option['icon_space_value'] != '' ? esc_attr( absint( $this->inline_option['icon_space_value'] ) ) . 'px' : ''; ?>;
	}
	<?php endif ?>
	/*inline margin*/
	<?php
	...
	div[class*="simplesocialbuttons-float"].simplesocialbuttons.simplesocial-sm-round button{
		margin: <?php echo $this->sidebar_option['icon_space'] == '1' && $this->sidebar_option['icon_space_value'] != '' ? esc_attr( absint( $this->sidebar_option['icon_space_value'] ) ) . 'px 0' : ''; ?>;
	}
	<?php endif ?>
	...
	<?php
	if ( isset( $this->selected_position['sidebar'] ) && $this->sidebar_option['icon_space'] == '1' ) :
		?>
