...
class SimpleSocialButtonsPR {
	 ...
	 * @var array
	 */
	public $arrKnownButtons = array( 'twitter', 'pinterest', 'fbshare', 'linkedin', 'reddit', 'whatsapp', 'viber', 'fblike', 'messenger', 'email', 'copylink', 'print', 'tumblr', 'bluesky', 'telegram', 'threads' );
	...
	public function ssb_output_cache_trigger( $info ) {
		if(function_exists( 'amp_is_request' ) && amp_is_request()){return $info;}
			...
			switch ( $button_name ) {
				...
				case 'fbshare':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-fb-share" ' . $ssb_attr_html . ' aria-label="Facebook Share" '. $ssb_trigger_attr .'="https://www.facebook.com/sharer/sharer.php?u=' . $permalink . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">Facebook </span> ';
				...
				case 'bluesky':
					...
					if ( $theme == 'simple-icons' ) {
						$_html .= '		<'.$ssb_element_tag.'  class="ssb_bluesky-icon" ' . $ssb_attr_html . ' aria-label="Bluesky Share" '. $ssb_trigger_attr .'="https://bsky.app/intent/compose?text=' . $permalink . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
				...
				case 'telegram':
					...
					if ( $theme == 'simple-icons' ) {
						$_html .= '		<'.$ssb_element_tag.'  class="ssb_telegram-icon" ' . $ssb_attr_html . ' aria-label="Telegram Share" '. $ssb_trigger_attr .'="https://t.me/share/url?url=' . $permalink . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
				...
				case 'threads':
					...
					if ( $theme == 'simple-icons' ) {
						$_html .= '		<'.$ssb_element_tag.'  class="ssb_threads-icon" ' . $ssb_attr_html . ' aria-label="threads Share"  '. $ssb_trigger_attr .'="https://www.threads.net/intent/post?text=' . $permalink . '" '.$ssb_click_attr.'="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
				...
				case 'twitter':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<'.$ssb_element_tag.' class="ssb_tweet-icon" ' . $ssb_attr_html . ' aria-label="Twitter Share" '. $ssb_trigger_attr .'="https://twitter.com/intent/tweet?text=' . $title . '&url=' . $permalink . '' . $via . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-twt-share" ' . $ssb_attr_html . ' aria-label="Twitter Share" '. $ssb_trigger_attr .'="https://twitter.com/intent/tweet?text=' . $title . '&url=' . $permalink . '' . $via . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">Twitter</span> ';
				...
				case 'copylink':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<'.$ssb_element_tag.' class="ssb_copylink-icon" ' . $ssb_attr_html . ' aria-label="Copy Link" '. $ssb_trigger_attr .'=" '.  $permalink . '"  ' . $ssb_click_attr . '="ssb_copy_share_link(this); return false;">
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-copy-link copy-share" ' . $ssb_attr_html . ' aria-label="Copy Link" '. $ssb_trigger_attr .'=" '.  $permalink . '"  ' . $ssb_click_attr . '="ssb_copy_share_link(this); return false;"><span class="simplesocialtxt">Copy</span><span class="ssb_tooltip">Copied</span> ';
				...
				case 'linkedin':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<'.$ssb_element_tag.' class="ssb_linkedin-icon" ' . $ssb_attr_html . ' aria-label="LinkedIn Share" '. $ssb_trigger_attr .'="' . ssb_linkdin_share_link( $permalink ) . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" >
						...
						$_html = '<'.$ssb_element_tag.' ' . $ssb_attr_html . ' class="simplesocial-linkedin-share" aria-label="LinkedIn Share" '. $ssb_trigger_attr .'="' . ssb_linkdin_share_link( $permalink ) .'" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">LinkedIn</span>';
				...
				case 'pinterest':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = ' <'.$ssb_element_tag.' class="ssb_pinterest-icon" ' . $ssb_attr_html . ' aria-label="Pinterest Share" '. $ssb_trigger_attr .'="https://www.pinterest.com/pin/create/button/?amp=1&guid=zoPaVezhUTzd&url=' . $permalink  .'"  ' . $ssb_click_attr . '="var e=document.createElement(\'script\');e.setAttribute(\'type\',\'text/javascript\');e.setAttribute(\'charset\',\'UTF-8\');e.setAttribute(\'src\',\'//assets.pinterest.com/js/pinmarklet.js?r=\'+Math.random()*99999999);document.body.appendChild(e);return false;">
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-pinterest-share" ' . $ssb_attr_html . ' aria-label="Pinterest Share" ' . $ssb_click_attr . '="var e=document.createElement(\'script\');e.setAttribute(\'type\',\'text/javascript\');e.setAttribute(\'charset\',\'UTF-8\');e.setAttribute(\'src\',\'//assets.pinterest.com/js/pinmarklet.js?r=\'+Math.random()*99999999);document.body.appendChild(e);return false;" ><span class="simplesocialtxt">Pinterest</span>';
				...
				case 'reddit':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-reddit-share" ' . $ssb_attr_html . ' aria-label="Reddit Share" '. $ssb_trigger_attr .'="https://reddit.com/submit?url=' . $permalink . '&title=' . $title . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" ><span class="simplesocialtxt">Reddit</span> ';
				...
				case 'whatsapp':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <'.$ssb_element_tag.'  ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'_blank\' );return false;" class="ssb_whatsapp-icon simplesocial-whatsapp-share" ' . $ssb_attr_html . ' aria-label="WhatsApp Share" '. $ssb_trigger_attr .'="' . ssb_whats_app_share_link( $permalink ) . '">
						...
						$arrButtonsCode[] = '<'.$ssb_element_tag.' ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'_blank\' );return false;" class="simplesocial-whatsapp-share" ' . $ssb_attr_html . ' aria-label="WhatsApp Share" '. $ssb_trigger_attr .'="' . ssb_whats_app_share_link( $permalink ) . '"><span class="simplesocialtxt">WhatsApp</span></'.$ssb_element_tag.'>';
					}
					break;
				case 'viber':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = '<'.$ssb_element_tag.'  ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'_self\' );return false;" class="simplesocial-viber-share ssb_viber-icon" ' . $ssb_attr_html . ' aria-label="Viber Share" '. $ssb_trigger_attr .'="' . ssb_viber_share_link($permalink) . '">
						...
						$arrButtonsCode[] = '<'.$ssb_element_tag.' ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'_self\' );return false;" class="simplesocial-viber-share" ' . $ssb_attr_html . ' aria-label="Viber Share" '. $ssb_trigger_attr .'="' . ssb_viber_share_link($permalink) . '"><span class="simplesocialtxt">Viber</span></'.$ssb_element_tag.'>';
					}
					break;
				case 'fblike':
					...
					$_html            = '<div class="fb-like ssb-fb-like" aria-label="Facebook Like" '. $ssb_trigger_attr .'="' . $permalink . '" data-layout="button_count" data-action="like" data-size="' . $button_size . '" data-show-faces="false" data-share="false"></div>';
					}
					$arrButtonsCode[] = $_html;
					break;
				case 'messenger':
					...
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = '<'.$ssb_element_tag.'  ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'_blank\',  \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\' );return false;" ' . $ssb_attr_html . '  aria-label="Facebook Messenger Share" class="simplesocial-viber-share ssb_msng-icon" '. $ssb_trigger_attr .'=' . $messenger_share_url . '>
						...
						$arrButtonsCode[] = '<'.$ssb_element_tag.' class="simplesocial-msng-share" ' . $ssb_attr_html . ' aria-label="Facebook Messenger Share" ' . $ssb_click_attr . '="javascript:window.open( this.dataset.href, \'_blank\',  \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\' );return false;" '. $ssb_trigger_attr .'="' . $messenger_share_url . '" ><span class="simplesocialtxt">Messenger</span></'.$ssb_element_tag.'> ';
					}
					break;
				case 'email':
					...
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <'.$ssb_element_tag.'  ' . $ssb_click_attr . '="javascript:window.location.href = this.dataset.href;return false;" class="ssb_email-icon simplesocial-email-share" aria-label="Share through Email" ' . $ssb_attr_html . ' '. $ssb_trigger_attr .'="mailto:?subject=' . $title . '&body=' . $permalink . '">
						...
						$arrButtonsCode[] = '<'.$ssb_element_tag.' ' . $ssb_click_attr . '="javascript:window.location.href = this.dataset.href;return false;" class="simplesocial-email-share" aria-label="Share through Email" ' . $ssb_attr_html . '  '. $ssb_trigger_attr .'="mailto:?subject=' . $title . '&body=' . $permalink . '"><span class="simplesocialtxt">Email</span></'.$ssb_element_tag.'>';
					}
					break;
				case 'print':
					if ( $theme == 'simple-icons' ) {
						$arrButtonsCode[] = ' <'.$ssb_element_tag.'  ' . $ssb_click_attr . '="javascript:window.print();return false;" aria-label="Print The Post" class=" ssb_print-icon simplesocial-email-share" ' . $ssb_attr_html . '>
						...
						$arrButtonsCode[] = '<'.$ssb_element_tag.' ' . $ssb_click_attr . '="javascript:window.print();return false;" ' . $ssb_attr_html . ' aria-label="Print Share" class="simplesocial-print-share" ><span class="simplesocialtxt">Print</span></'.$ssb_element_tag.'>';
					}
					break;
				case 'tumblr':
					...
					if ( $theme == 'simple-icons' ) {
						$_html = '<'.$ssb_element_tag.' class="ssb_tumblr-icon" ' . $ssb_attr_html . ' aria-label="Tumblr Share" '. $ssb_trigger_attr .'="' . $tumblr_share_url . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<'.$ssb_element_tag.' class="simplesocial-tumblr-share" ' . $ssb_attr_html . ' aria-label="Tumblr Share" '. $ssb_trigger_attr .'="' . $tumblr_share_url . '" ' . $ssb_click_attr . '="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;" ><span class="simplesocialtxt">Tumblr</span> ';
	...
	public function include_sidebar() {
		...
		if ( isset( $this->selected_position['sidebar'] ) && in_array( $this->get_post_type(), $this->_get_settings( 'sidebar', 'posts', array() ) ) ) {
			...
			if ( in_array( $this->get_post_type(), $this->sidebar_option['posts'] ) ) {
				...
				if ( $show_hover_text == true ) {
					$class .= ' ssb_show_text_hover';
				}
				if( isset($flat_button_sidebar) && $flat_button_sidebar == true ){
