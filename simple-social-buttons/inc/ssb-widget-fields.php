...
<div class="simpleshare-checklist">
	<input type="checkbox" value="1" class="show_fb_check"   name="<?php echo esc_attr( $this->get_field_name( 'show_facebook' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_facebook' ) ); ?>" <?php checked( $show_facebook, 1 ); ?>> <label for="<?php echo esc_attr( $this->get_field_id( 'show_facebook' ) ); ?>"><?php esc_html_e( 'Facebook', 'simple-social-buttons' ); ?></label>
	<br/>
	<input type="checkbox" value="1" class="show_twitter_check" name="<?php echo esc_attr( $this->get_field_name( 'show_twitter' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_twitter' ) ); ?>" <?php checked( $show_twitter ); ?>> <label for="<?php echo esc_attr( $this->get_field_id( 'show_twitter' ) ); ?>"><?php esc_html_e( 'Twitter', 'simple-social-buttons' ); ?></label>
	<br/>
	<input type="checkbox" value="1" class="show_youtube_check" name="<?php echo esc_attr( $this->get_field_name( 'show_youtube' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_youtube' ) ); ?>" <?php checked( $show_youtube, 1 ); ?> > <label for="<?php echo esc_attr( $this->get_field_id( 'show_youtube' ) ); ?>"><?php esc_html_e( 'YouTube', 'simple-social-buttons' ); ?></label>
	<br/>
	<input type="checkbox" value="1" class="show_pinterest_check" name="<?php echo esc_attr( $this->get_field_name( 'show_pinterest' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_pinterest' ) ); ?>" <?php checked( $show_pinterest, 1 ); ?> > <label for="<?php echo esc_attr( $this->get_field_id( 'show_pinterest' ) ); ?>"><?php esc_html_e( 'Pinterest', 'simple-social-buttons' ); ?></label>
	<br/>
	<input type="checkbox" value="1" class="show_instagram_check" name="<?php echo esc_attr( $this->get_field_name( 'show_instagram' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_instagram' ) ); ?>" <?php checked( $show_instagram, 1 ); ?> > <label for="<?php echo esc_attr( $this->get_field_id( 'show_instagram' ) ); ?>"><?php esc_html_e( 'Instagram', 'simple-social-buttons' ); ?></label>
	<br/>
	<input type="checkbox" value="1" class="show_whatsapp_check" name="<?php echo esc_attr( $this->get_field_name( 'show_whatsapp' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'show_whatsapp' ) ); ?>" <?php checked( $show_whatsapp, 1 ); ?> > <label for="<?php echo esc_attr( $this->get_field_id( 'show_whatsapp' ) ); ?>"><?php esc_html_e( 'WhatsApp', 'simple-social-buttons' ); ?></label>
</div>
<!--facebook-->
<div class="show_fb simpleshare-widget-settings" style="display: <?php echo ( $display == $show_facebook ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'Facebook', 'simple-social-buttons' ); ?></span></h2>
	...
	<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'facebook_id' ) ); ?>"><?php esc_html_e( 'Facebook Page Name:', 'simple-social-buttons' ); ?></label>
	...
	value="1" <?php checked( $facebook_show_counter, 1 ); ?> class="fb_count_check" ><label for="<?php echo esc_attr( $this->get_field_id( 'facebook_show_counter' ) ); ?>"> <?php esc_html_e( 'Display Facebook like counter', 'simple-social-buttons' ); ?></label>
	</p>
...
<div class="show_twitter simpleshare-widget-settings" style="display: <?php echo ( $display == $show_twitter ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'Twitter', 'simple-social-buttons' ); ?></span></h2>
...
<p>
	...
	value="1" <?php checked( $twitter_show_counter, 1 ); ?> class="twitter_count_check" ><label for="<?php echo esc_attr( $this->get_field_id( 'twitter_show_counter' ) ); ?>"> <?php esc_html_e( 'Display Twitter follower counter', 'simple-social-buttons' ); ?></label>
</p>
...
<div class="show_youtube simpleshare-widget-settings" style="display: <?php echo ( $display == $show_youtube ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'YouTube', 'simple-social-buttons' ); ?></span></h2>
<p>
...
<p>
	...
	<option <?php selected( $youtube_type, 'channel' ); ?> value="channel"><?php esc_html_e( 'Channel', 'simple-social-buttons' ); ?></option>
	<option <?php selected( $youtube_type, 'user' ); ?> value="user"><?php esc_html_e( 'Username', 'simple-social-buttons' ); ?></option>
	</select>
</p>
...
<p  class="youtube_text" style="display: block">
	...
	<label for="<?php echo esc_attr( $this->get_field_id( 'youtube_show_counter' ) ); ?>"> <?php esc_html_e( 'Display YouTube subscriber counter', 'simple-social-buttons' ); ?></label>
</p>
...
<div class="show_pinterest simpleshare-widget-settings" style="display: <?php echo ( $display == $show_pinterest ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'Pinterest', 'simple-social-buttons' ); ?></span></h2>
	<p>
	...
	<p  class="pinterest_text" style="display: block">
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_show_counter' ) ); ?>"><?php esc_html_e( 'Display Pinterest follower counter', 'simple-social-buttons' ); ?></label>
	</p>
...
<div class="show_instagram simpleshare-widget-settings" style="display: <?php echo ( $display == $show_instagram ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'Instagram', 'simple-social-buttons' ); ?></span></h2>
	<p>
	...
	<p  class="instagram_text" style="display: block">
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_show_counter' ) ); ?>"><?php esc_html_e( 'Display Instagram follower counter', 'simple-social-buttons' ); ?></label>
	</p>
...
<div class="show_whatsapp simpleshare-widget-settings" style="display: <?php echo ( $display == $show_whatsapp ) ? 'block' : 'none'; ?>">
	<h2><span><?php esc_html_e( 'WhatsApp', 'simple-social-buttons' ); ?></span></h2>
	<p>
