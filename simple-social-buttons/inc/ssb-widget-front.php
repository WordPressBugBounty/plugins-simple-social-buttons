...
<?php if ( $display == $show_youtube ) : ?>
	<a class="ssb_button simplesocial-yt-follow" rel="noopener" href="https://youtube.com/<?php echo esc_attr( $youtube_type ); ?>/<?php echo esc_attr( $youtube_id ); ?>" target="_blank">
